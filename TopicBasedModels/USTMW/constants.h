...
struct Model_Para
{
    ...
    string dir;
    string data_file;
    string data_demo_file;              // used for USTM_FW_W
    string save_model_name;
    string senti_lex_file;              // used for JST, USTM_FW_W
    double alpha;
    double beta;
    double gamma;                       // used for JST, USTM_FW_W
    double eta;                         // used for D_PLDA
    int numTopics;
    int numSentis;                      // used for JST, USTM_FW_W
    int niters;
    int twords;
    string wordmapfile;
    string demomapfile;                 //  used for USTM_FW_W
