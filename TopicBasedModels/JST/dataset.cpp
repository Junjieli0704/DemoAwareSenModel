...
int dataset::read_traindata(string dfile, string wordmapfile, string mode = "word") {
...
int dataset::analyze_train_corpus(string wordmapfile) {
...
int dataset::analyze_test_corpus(string wordmapfile) {
    ...
    //cout<<"dataset::analyze_test_corpus()  begin....\n";
